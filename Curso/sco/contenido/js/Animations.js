...
// Para desactivar botones en la pantalla de evaluacion solo hay que poner activaBotones(false);
function activaBotones(val) {
  switch (val) {
    case false:
      parent.desactivaBotonesNav();
      break;
  
    default:
      parent.activaBotonesNav();
      break;
  }
}
activaBotones();
